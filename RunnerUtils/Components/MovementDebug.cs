...
namespace RunnerUtils.Components
{
    ...
    public class MovementDebug
    {
        ...
        static InGameLog igl = new InGameLog($"{Mod.pluginName}~Movement Info", 10);
        ...
        private static void SetupIndicator() {
            ...
            m_obj = GameObject.Instantiate(new GameObject(), gps.transform.parent.gameObject.transform);
